...
module.exports.getAllArt = async (req,res) => {
 ...
 module.exports.updateArt = async (req,res) => {
    try {
        const updated = await new Art({Id: req.params.Id,decoded: req.decoded, ...req.body}).updateArt()
 ...
 module.exports.deleteArt = async (req,res) => {
    try {
        const deleted = await new Art({Id: req.params.Id,decoded: req.decoded, ...req.body}).deleteArt()
